...
void mbed_init(void)
{
    ...
    us_ticker_init();
#endif
    debug_log("mbed_init", sizeof("mbed_init"));
    mbed_rtos_init();
}

void mbed_start(void)
{
    debug_log("mbed_start start",sizeof("mbed_start start"));
    mbed_toolchain_init();
    debug_log("mbed_start 1",sizeof("mbed_start 1"));
    mbed_main();
    debug_log("mbed_start 2",sizeof("mbed_start 2"));
    mbed_error_initialize();
    debug_log("mbed_start 3",sizeof("mbed_start 3"));
    // lwq need to change to __real_main to avoid Infinite loop
    // main();
    __real_main();
    debug_log("mbed_start end",sizeof("mbed_start end"));
}
...
{
    // Nothing by default
    debug_log("mbed_main start",sizeof("mbed_main start"));
    debug_log("mbed_main end",sizeof("mbed_main end"));
}
