...
void software_init_hook(void)
{
    ...
    // printf("software_init_hook\n");
    debug_log("software_init_hook",sizeof("software_init_hook"));
    mbed_init();
    debug_log("software_init_hook 1",sizeof("software_init_hook 1"));
    mbed_rtos_start();
    debug_log("software_init_hook 2",sizeof("software_init_hook 2"));
}

void mbed_toolchain_init()
{
    // printf("mbed_toolchain_init start\n");
    ...
    // printf("mbed_toolchain_init 2\n");

    /* Run the C++ global object constructors */
    // __libc_init_array();
    // printf("mbed_toolchain_init end\n");
}

extern int __real_main(void);
int __wrap_main(void)
{
    debug_log("__wrap_main start",sizeof("__wrap_main start"));
    software_init_hook();
    /* For backwards compatibility */
    debug_log("__wrap_main 1",sizeof("__wrap_main 1"));
    // return __real_main();
    debug_log("__wrap_main end",sizeof("__wrap_main end"));
    return 0;
}
