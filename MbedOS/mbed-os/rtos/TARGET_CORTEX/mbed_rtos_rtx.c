...
void mbed_rtos_init()
{
    debug_log("mbed_rtos_init",sizeof("mbed_rtos_init"));
    osKernelInitialize();
}

MBED_NORETURN void mbed_rtos_start()
{
    debug_log("mbed_rtos_start",sizeof("mbed_rtos_start"));
...
// #endif // defined(TARGET_TFM) && defined(COMPONENT_NSPE)
    debug_log("mbed_rtos_start 1",sizeof("mbed_rtos_start 1"));
    singleton_mutex_id = osMutexNew(&singleton_mutex_attr);
    debug_log("mbed_rtos_start 2",sizeof("mbed_rtos_start 2"));
